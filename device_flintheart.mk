...
$(call inherit-product-if-exists, vendor/zte/flintheart/x5max_pro-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/zte/flintheart/overlay
PRODUCT_PACKAGE_OVERLAYS += device/zte/flintheart/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/zte/flintheart
